...
if __name__=="__main__":
    x={"farm_id":61,"domain":"electronics-pcb","objective":"interface transport self-test","method":"deterministic-roundtrip","evidence_level":"E2","validation":"hash","priority":"normal","task_type":"interop","payload":{"claim":"transport test only"}}
    p=encode(x);assert verify(p);print(json.dumps({"status":"VERIFIED","farm_id":61,"sha256":p["sha256"]}))
